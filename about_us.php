...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background: color #859191; padding:6px 6px 6px 6px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:white;" text-shadow:2px 2px 2px gray;>About Us</h1>
            </div>
            <br><br>
            <img src="images/Munu.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h2 style="color:white;"><em>Munu Singh</em></h2>
            <p style="color:gray;"><b>Intern at The Sparks Foundation <br>Indira Gandhi Institute Of Tecnology,Sarang</b></p>
    </center>
