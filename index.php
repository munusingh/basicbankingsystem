...
<head>
    ...
    <style>
        ...
        .facility-boxes{
            ...
            width: 90%;
            border-radius: 30px;
            box-shadow: 3px 3px 8px grey, -1px -1px 6px white;
            max-width: 33vw;
            min-height: 42vh;
            display: flex;
...
<body style="background-color:#F2CAC8;">
...
<div id="container">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 2.8px 3px grey; text-align:center;">
                    <b>Welcome to <br> Sparks
                        Bank</b></p>
            </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px #0000005e; border-radius:30px; padding:20px 0px 20px 0px;">
